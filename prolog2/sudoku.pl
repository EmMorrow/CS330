...
solve(Board) :-   % ---PUT CODE HERE---
	...
	checkCells(Cubes, Columns, Rows,0,0),
	checkCells(Cubes, Columns, Rows,0,1),
	checkCells(Cubes, Columns, Rows,0,2),
	checkCells(Cubes, Columns, Rows,0,3),
	checkCells(Cubes, Columns, Rows,0,4),
	checkCells(Cubes, Columns, Rows,0,5),
	checkCells(Cubes, Columns, Rows,0,6),
	checkCells(Cubes, Columns, Rows,0,7),
	checkCells(Cubes, Columns, Rows,0,8),
	checkCells(Cubes, Columns, Rows,1,0),
	checkCells(Cubes, Columns, Rows,1,1),
	checkCells(Cubes, Columns, Rows,1,2),
	checkCells(Cubes, Columns, Rows,1,3),
	checkCells(Cubes, Columns, Rows,1,4),
	checkCells(Cubes, Columns, Rows,1,5),
	checkCells(Cubes, Columns, Rows,1,6),
	checkCells(Cubes, Columns, Rows,1,7),
	checkCells(Cubes, Columns, Rows,1,8),
	checkCells(Cubes, Columns, Rows,2,0),
	checkCells(Cubes, Columns, Rows,2,1),
	checkCells(Cubes, Columns, Rows,2,2),
	checkCells(Cubes, Columns, Rows,2,3),
	checkCells(Cubes, Columns, Rows,2,4),
	checkCells(Cubes, Columns, Rows,2,5),
	checkCells(Cubes, Columns, Rows,2,6),
	checkCells(Cubes, Columns, Rows,2,7),
	checkCells(Cubes, Columns, Rows,2,8),
	checkCells(Cubes, Columns, Rows,3,0),
	checkCells(Cubes, Columns, Rows,3,1),
	checkCells(Cubes, Columns, Rows,3,2),
	checkCells(Cubes, Columns, Rows,3,3),
	checkCells(Cubes, Columns, Rows,3,4),
	checkCells(Cubes, Columns, Rows,3,5),
	checkCells(Cubes, Columns, Rows,3,6),
	checkCells(Cubes, Columns, Rows,3,7),
	checkCells(Cubes, Columns, Rows,3,8),
	checkCells(Cubes, Columns, Rows,4,0),
	checkCells(Cubes, Columns, Rows,4,1),
	checkCells(Cubes, Columns, Rows,4,2),
	checkCells(Cubes, Columns, Rows,4,3),
	checkCells(Cubes, Columns, Rows,4,4),
	checkCells(Cubes, Columns, Rows,4,5),
	checkCells(Cubes, Columns, Rows,4,6),
	checkCells(Cubes, Columns, Rows,4,7),
	checkCells(Cubes, Columns, Rows,4,8),
	checkCells(Cubes, Columns, Rows,5,0),
	checkCells(Cubes, Columns, Rows,5,1),
	checkCells(Cubes, Columns, Rows,5,2),
	checkCells(Cubes, Columns, Rows,5,3),
	checkCells(Cubes, Columns, Rows,5,4),
	checkCells(Cubes, Columns, Rows,5,5),
	checkCells(Cubes, Columns, Rows,5,6),
	checkCells(Cubes, Columns, Rows,5,7),
	checkCells(Cubes, Columns, Rows,5,8),
	checkCells(Cubes, Columns, Rows,6,0),
	checkCells(Cubes, Columns, Rows,6,1),
	checkCells(Cubes, Columns, Rows,6,2),
	checkCells(Cubes, Columns, Rows,6,3),
	checkCells(Cubes, Columns, Rows,6,4),
	checkCells(Cubes, Columns, Rows,6,5),
	checkCells(Cubes, Columns, Rows,6,6),
	checkCells(Cubes, Columns, Rows,6,7),
	checkCells(Cubes, Columns, Rows,6,8),
	checkCells(Cubes, Columns, Rows,7,0),
	checkCells(Cubes, Columns, Rows,7,1),
	checkCells(Cubes, Columns, Rows,7,2),
	checkCells(Cubes, Columns, Rows,7,3),
	checkCells(Cubes, Columns, Rows,7,4),
	checkCells(Cubes, Columns, Rows,7,5),
	checkCells(Cubes, Columns, Rows,7,6),
	checkCells(Cubes, Columns, Rows,7,7),
	checkCells(Cubes, Columns, Rows,7,8),
	checkCells(Cubes, Columns, Rows,8,0),
	checkCells(Cubes, Columns, Rows,8,1),
	checkCells(Cubes, Columns, Rows,8,2),
	checkCells(Cubes, Columns, Rows,8,3),
	checkCells(Cubes, Columns, Rows,8,4),
	checkCells(Cubes, Columns, Rows,8,5),
	checkCells(Cubes, Columns, Rows,8,6),
	checkCells(Cubes, Columns, Rows,8,7),
	checkCells(Cubes, Columns, Rows,8,8).


checkCells(Cubes, Cols, Rows, RowLoc, ColLoc) :-
	nth0(ColLoc, Cols, Col),
	nth0(RowLoc, Rows, Row),
	nth0(RowLoc, Col, Cell),
	cubeNum(RowLoc, ColLoc, CubeLoc),
	nth0(CubeLoc, Cubes, Cube),
